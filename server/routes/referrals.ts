...
function referralBaseUrl() {
  // This configured public URL prevents development localhost URLs from being
  // shared. Set NEXT_PUBLIC_SITE_URL to a custom domain when one is available.
...
router.get("/", async (req: AuthRequest, res) => {
  ...
  res.json({
    referralLink: `${referralBaseUrl()}/register?ref=${user.referralCode}`,

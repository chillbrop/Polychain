...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Withdrawals can be requested any time from your wallet page. USDT, BTC, ETH, SOL and BSC withdrawals are processed quickly, typically within minutes during business hours and are subject to a small network fee. Minimum withdrawal is $10.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "USDT (TRC-20) deposits typically confirm within 1-2 minutes. BTC, ETH, SOL and BSC confirm based on network congestion. Once the transaction is confirmed on-chain, it's credited to your wallet automatically.",
  },
  {
